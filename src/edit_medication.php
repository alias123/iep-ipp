       ...
       if(!($_POST['end_date'] == ""  || preg_match($regexp,$_POST['end_date']))) { $MESSAGE = $MESSAGE . "End Date must be in YYYY-MM-DD format<BR>"; }
          ...
          if(!$update_result) {
            ...
            IPP_LOG($MESSAGE,$_SESSION['egps_username'],'ERROR');
             ...
             //redirect back...
             header("Location: " . IPP_PATH . "src/medication_view.php?student_id=" . $student_id);
          }
       }
     }
   }
            ...
            <td class="shadow-center" valign="top">
                <table class="frame" width=620px align=center border="0">
                    ...
                    <tr>
                        ...
                        <center>
                        <form name="edit_medication" enctype="multipart/form-data" action="<?php echo IPP_PATH . "src/edit_medication.php"; ?>" method="post" <?php if(!$have_write_permission) echo "onSubmit=\"return noPermission();\"" ?>>
