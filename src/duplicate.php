...
/**
 * duplicate.php -- copy a program plan (san's demographics)
 *
...
<HEAD>
    ...
    <BODY>
            ...
            <td class="shadow-center" valign="top">
                <table class="frame" width=620px align=center border="0">
                    ...
                    <tr>
                        ...
                        <center>
                        <form name="addName" enctype="multipart/form-data" action="<?php echo IPP_PATH . "src/duplicate.php"; ?>" method="post">
        ...
        <tr>
            ...
            <?php
                echo IPP_PATH . "src/manage_student.php?$szBackGetVars";
