...
$code_query = "SELECT * FROM coding WHERE student_id =" . AddSlashes($student_id) . " AND end_date IS NULL";
            ...
            <td class="shadow-center" valign="top">
                <table class="frame" width=620px align=center border="0">
                    ...
                    <tr>
                        ...
                        <center>
                        <form name="changeCode" enctype="multipart/form-data" action="<?php echo IPP_PATH . "src/coding.php"; ?>" method="get" <?php if(!$have_write_permission) echo "onSubmit=\"return noPermission();\"" ?>>
                        ...
                        <form name="ipphistorylist" onSubmit="return deleteChecked()" enctype="multipart/form-data" action="<?php echo IPP_PATH . "src/coding.php"; ?>" method="get">
                        <input type="hidden" name="student_id" value="<?php echo $student_id ?>">
                        ...
                        while ($code_history_row=mysql_fetch_array($code_history_result)) {
                            ...
                            echo "<td bgcolor=\"$bgcolor\"><center><a href=\"" . IPP_PATH . "src/edit_coding.php?uid=" . $code_history_row['uid'] . "\" class=\"editable_text\">" . $code_history_row['code'] . "</a></center></td>\n";
                            echo "<td bgcolor=\"$bgcolor\"><a href=\"" . IPP_PATH . "src/edit_coding.php?uid=" . $code_history_row['uid'] . "\" class=\"editable_text\">" . $code_history_row['start_date'] . "</a></td>\n";
                            if($code_history_row['end_date'] == "" )
                              echo "<td bgcolor=\"$bgcolor\"><a href=\"" . IPP_PATH . "src/edit_coding.php?uid=" . $code_history_row['uid'] . "\" class=\"editable_text\">-Ongoing-</a></td>\n";
                            else
                              echo "<td bgcolor=\"$bgcolor\"><a href=\"" . IPP_PATH . "src/edit_coding.php?uid=" . $code_history_row['uid'] . "\" class=\"editable_text\">" . $code_history_row['end_date'] . "</a></td>\n";
                            echo "</tr>\n";
