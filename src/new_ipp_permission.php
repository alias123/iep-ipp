            ...
            <td class="shadow-center" valign="top">
                <table class="frame" width=620px align=center border="0">
                    ...
                    <tr>
                        ...
                        <tr>
                          <td bgcolor="#E0E2F2" align="left">Username:</td><td bgcolor="#E0E2F2">
                          <?php
                              ...
                              echo "</SELECT>\n"
                          ?>
                          </td><td valign="center" align="left" bgcolor="#E0E2F2" rowspan="8">&nbsp;&nbsp;<input type="submit" value="Add" name="ACTION"></td>
                        </tr>
                        <tr>
                            <td bgcolor="#E0E2F2" colspan="2">
                             &nbsp;
                            </td>
                        </tr>
                        <tr>
                           ...
                           <td bgcolor="#E0E2F2">
                               <SELECT name="permission_level" style="width:200px;text-align: left;">
                               <OPTION value="READ" SELECTED>READ
                               <OPTION value="WRITE">WRITE
                               <OPTION value="ASSIGN">ASSIGN
                               <?php
