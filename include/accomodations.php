                ...
                <table class="frame" width=620px align=center border="0">
                    ...
                    <tr>
                        ...
                        while ($accomodation_row=mysql_fetch_array($accomodation_result)) { //current...
                            ...
                            echo "<td bgcolor=\"$bgcolor\" class=\"row_default\"><a href=\"" . IPP_PATH . "src/edit_accomodations.php?uid=" . $accomodation_row['uid'] . "\" class=\"editable_text\">" . $accomodation_row['accomodation']  ."</a></td>\n";
