<?php
    function navbar($szBack="main.php") {
        ...
        //home button
        echo "<td width=\"60\" class=\"navbar_left\"><a href=\"" . IPP_PATH . "src/main.php\" tabindex=\"-1\"><img src=\"" . IPP_PATH . "images/homebutton.png\" border=\"0\"></a></td>";
        echo "<td width=\"60\" class=\"navbar_middle\">";
        //back button
        echo "<a href=\"" . IPP_PATH . "src/$szBack\" tabindex=\"-1\">";
        echo "<img src=\"" . IPP_PATH . "images/back-arrow.png\" border=\"0\"></a></td>";
        echo "<td width=\"60\" align=\"right\" class=\"navbar_middle\"><a href=\"" . IPP_PATH . "src/about.php\" tabindex=\"-1\"><img src=\"" . IPP_PATH . "images/about.png\" border=\"0\"></a></td>";
        ...
        else echo "<td width=\"60\" class=\"navbar_middle\"><a href=\"" . IPP_PATH . "src/student_view.php?student_id=$student_id\" tabindex=\"-1\"><img src=\"" . IPP_PATH . "images/studentinfo.png\" border=\"0\"></a></td>";
        ...
        echo "<td width=\"60\" align=\"right\" class=\"navbar_middle\"><a href=\"" . IPP_PATH . "src/ipp_pdf.php?student_id=$student_id\" target=\"_blank\" tabindex=\"-1\"><img src=\"" . IPP_PATH . "images/view_ipp_60x60.png\" border=\"0\"></a></td>";
